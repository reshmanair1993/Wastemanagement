...
/**
 * CmsPostSearch represents the model behind the search form of `backend\models\CmsPost`.
 */
class CmsPostSearch extends CmsPost
{
    ...
    {
        return [
            [['id', 'featured_image_id', 'post_type', 'status'], 'integer'],
            [['name', 'title_ml', 'title_en', 'sub_title_en', 'sub_title_ml', 'description_en', 'description_ml', 'slug', 'date', 'created_at', 'modified_at'], 'safe'],
        ];
    }
