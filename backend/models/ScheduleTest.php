 ...
 */
class ScheduleTest extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['lsgi_id', 'account_id_creator', 'week_day', 'month_day', 'repeat_day_count', 'service_id', 'status','ward_id','type','account_id_gt','green_action_unit_id'], 'integer'],
            [['lsgi_id'], 'required'],
    ...
    public function deleteSchedule($id)
    {
       ...
       $connection->createCommand()->update('schedule_test', ['status' => 0], 'id=:id')->bindParam(':id',$id)->execute();
       return true;
    }
