 ...
 */
class NonResidentialWasteCollectionIntervalSearch extends NonResidentialWasteCollectionInterval
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = NonResidentialWasteCollectionInterval::find()->where(['status'=>1])->orderby('id DESC');
