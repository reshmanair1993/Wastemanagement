...
class Customer extends \yii\db\ActiveRecord
{
     ...
     * @var mixed
     */
    public $district_id, $block_id, $assembly_constituency_id, $lsgi_id,$code,$no_association,$building_type_name;
    /**
     * {@inheritdoc}
     */
...
else
{
    ...
    // }
         public function getWardHouseCount($id = null,$from=null,$to=null)
    {
       //      $qry ="UPDATE ward_customer_count set ward_customer_count.house_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=1 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
      $count =0 ;
       //  $query = "SELECT sum(ward_customer_count.house_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
       //   if($from!=null)
       //  {
       //      $query.= " and ward_customer_count.date >= :from";
       //  }
       //  if($to!=null)
       //  {
       //      $query.= " and ward_customer_count.date <= :to";
       //  }
       // $command =  Yii::$app->db->createCommand($query)
       // ->bindParam(':id',$id)
       // ;
       ...
       //  $command->bindParam(':to',$to);
       // }
        $query = "SELECT count(customer.id)  as count FROM customer WHERE customer.ward_id=:id and customer.building_type_id=1 and customer.status=1" ;
         if($from!=null)
        {
            $query.= " and customer.created_at >= :from";
        }
...
else
{
    ...
    public function getWardFlatCount($id = null,$from=null,$to=null)
    {
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.flat_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=3 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
        $count =0 ;
        $query = "SELECT sum(ward_customer_count.flat_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    ...
    public function getWardShopCount($id = null,$from=null,$to=null)
    {
       ...
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.shop_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=2 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date)  where ward_customer_count.ward_id=:id ";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
        // $count  = 0;
        $count =0 ;
        $query = "SELECT sum(ward_customer_count.shop_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
     ...
     public function getWardHospitalCount($id = null,$from=null,$to=null)
    {
       ...
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.hospital_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=5 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
        $count  = 0;
       $query = "SELECT sum(ward_customer_count.hospital_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    ...
    public function getWardPublicPlaceCount($id = null,$from=null,$to=null)
    {
       ...
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.public_place_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=6 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
       $count =0 ;
        $query = "SELECT sum(ward_customer_count.public_place_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    $count =0;
     ...
     public function getWardReligiousCount($id = null,$from=null,$to=null)
    {
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.religious_institution_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=11 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
       $count =0 ;
       $query = "SELECT sum(ward_customer_count.religious_institution_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    ...
    public function getWardOfficeCount($id = null,$from=null,$to=null)
    {
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.office_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=7 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
        $count =0 ;
        $query = "SELECT sum(ward_customer_count.office_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    ...
    public function getWardAuditoriumCount($id = null,$from=null,$to=null)
    {
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.auditorium_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=9 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
        $count  = 0;
        $query = "SELECT sum(ward_customer_count.auditorium_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
...
else
{
    $count =0;
     ...
     public function getWardMarketCount($id = null,$from=null,$to=null)
    {
       //  $qry ="UPDATE ward_customer_count set ward_customer_count.market_count=(SELECT count(*) FROM customer WHERE ward_customer_count.status=1 and customer.status=1 and customer.building_type_id=10 and customer.ward_id=:id and date(customer.created_at)=ward_customer_count.date) where ward_customer_count.ward_id=:id";
       //  $command1 =  Yii::$app->db->createCommand($qry)
       // ->bindParam(':id',$id);
       // $ret = $command1->execute();
       $count =0 ;
        $query = "SELECT sum(ward_customer_count.market_count)  as count FROM ward_customer_count WHERE ward_customer_count.ward_id=:id" ;
         if($from!=null)
        {
            $query.= " and ward_customer_count.date >= :from";
        }
