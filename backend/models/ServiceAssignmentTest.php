 ...
 */
class ServiceAssignmentTest extends \yii\db\ActiveRecord
{
    ...
    {
        return 'service_assignment_test';
    }
...
//     }
    ...
    {
        return $this->hasOne(ServiceRequestTest::className(), ['id' => 'service_request_id'])->andWhere(['status'=>1]);
    }
