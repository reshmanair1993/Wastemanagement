...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
             <p>
        <?= Html::button(' Reassign',['class' => 'btn btn-success confirm_button','data-status' => 2,'data-toggle'=>"modal" ,'data-target'=>"#myModal"])?>
    </p>
        </div>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'reassign','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
        <?=$this->render('reassign-gt', ['modelAccount' => $modelAccount,'hks'=>$hks,'supervisor'=>$supervisorId]);?>
      </div>
      </div>
