...
<tr class="footable-even  " data-key="9">
	...
	<td style="width: 200px"><?=$model->rating_value?></td>
	...
	<td style="width: 50px">
	<?php $deleteUrl = Yii::$app->urlManager->createUrl(['lsgis/delete-customer-rating','id'=>$model->id]);?>
	<a onclick="ConfirmDelete(function(){
		deleteItem('<?=$deleteUrl?>','#Pjax-add-customer-rating',1,function() {});})" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"><i aria-hidden="true" class="ti-close"></i></a></td>
</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Customer Rating</h4>
      </div>
      <div class="modal-body">
        <div class="row">
        <?php 
    echo
    $this->render('update-customer-rating',[
            'modelEvaluationConfigCustomerRating'=> $model,
            ]);?>
      </div>
      </div>
