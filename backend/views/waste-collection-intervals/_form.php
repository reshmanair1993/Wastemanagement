...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Waste Collection Interval</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Waste Collection Interval', 'url' => ['/waste-collection-intervals']];
  ...
  <div class="white-box">
    <div class="row">
      <div class="col-sm-12 col-xs-12">
        ...
        echo $form->field($model, 'building_type_available')->checkboxList($listData)->label('Building Types Available for Waste Collection Method') ?>
        </div>
      </div>
    </div>
