...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Customer Self Service</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Customer Self Service', 'url' => ['self-services/inoculam-bags-requests']];
   $this->title =  'Create';
  ...
  <div class="white-box">
    <div class="row">
      <div class="col-sm-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => ['update-self-service','id'=>$model->id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);?>
        <div class="row">
         <div class="col-sm-4 col-xs-4">
           ...
           <div class="col-sm-4 col-xs-4">
                <div class="form-group">
                    <div class="col-sm-7 col-xs-4">
                        <?php $service=Service::find()->where(['status'=>1])->andWhere(['type'=>1])->andWhere(['is_quantity_entering_enabled'=>1])->all();
