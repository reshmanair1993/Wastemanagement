...
<div class="technician-create">
  ...
  $breadcrumb[] = ['label' => $this->title,'template' => "<li class='active' , style='color:#4AAFF4;'>{link}</li>\n"];
    ...
    <div class="group-form">
      ...
      <?php $form = ActiveForm::begin(['action' =>['create-technician'],'options' => ['','data-pjax' => true,'class' => 'add-engg-form','enableAjaxValidation' => false,'enableClientValidation'=>true]]); ?>
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
          <div class="row">
            <div class="form-group col-lg-12 col-md-12 col-sm-6 col-12">
              <label for="eh-first-name">Technician name</label>
              <?= $form->field($modelPerson, 'first_name')->textInput(['class' => 'form-control','placeholder' => 'Technician name'])->label(false); ?>
            </div>
          </div>
