...
$this->title = Yii::t('app', 'Create Monitoring Person');
...
<div class="technician-create">
  ...
  if($model->id){
     $this->title =  'Create Monitoring Person';
  }
  else
  {
     $this->title =  'Create';
  ...
  $breadcrumb[] = ['label' => $this->title,'template' => "<li class='active' , style='color:#4AAFF4;'>{link}</li>\n"];
    ...
    <div class="group-form">
      ...
      <?php $form = ActiveForm::begin(['action' =>['create-monitoring-person'],'options' => ['','data-pjax' => true,'class' => 'add-engg-form','enableAjaxValidation' => false,'enableClientValidation'=>true]]); ?>
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
          <div class="row">
            <div class="form-group col-lg-12 col-md-12 col-sm-6 col-12">
                <label for="eh-first-name">Monitoring Person name</label>
                <?= $form->field($modelPerson, 'first_name')->textInput(['class' => 'form-control','placeholder' => 'Monitoring Person name'])->label(false); ?>
              </div>
            </div>
 ...
 <?php }?>
      ...
      <div class="row">
        <div class="col-lg-12 ta-right">
          <a href="<?=Url::to(['/monitoring-group-users/index'])?>" class="btn btn-success">cancel</a>
