...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <?php if(Yii::$app->user->can('services-create')||$userRole=='super-admin'):?>
      ...
      <div class="scrollable">
        <div class="table-responsive">
          <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
                      'id' =>'pjax-services-list', 'options'=>['data-loader'=>'.preloader']]); ?>
    <?php
    $columns = [
            [
                    'attribute' => 'name',
                    ...
                    'value'=>function ($model) {
                      ...
                      $modelUser  = Yii::$app->user->identity;
                      $userRole = $modelUser->role;
                      if(Yii::$app->user->can('services-view-service')||$userRole=='super-admin'):
                      return Html::a($model->name,['services/view-service?id='.$model->id],['data-pjax'=>0]);
                    else:
                      return $model->name;
                    endif;
                    },
       ...
       ];if(Yii::$app->user->can('services-delete-service')||$userRole=='super-admin'){
        $columns2 = [             
                    [
                   'attribute' => 'delete',
                   'label' =>'Delete',
                   ...
                   'value'=>function ($model) {
                    ...
                    return  "<a  onclick=\"ConfirmDelete(function(){
                      deleteItem('$url','#pjax-services-list',$page,function() {
                      });
