...
$modelImage = new Image;
	Pjax::begin(['timeout' => 50000 ,'enablePushState' => false, 'id' =>'Pjax-add-stakeholder','options'=>['data-loader'=>'.preloader']]);
	$form = ActiveForm::begin(['action' => ['add-stakeholder','id'=>$modelResidentialAssociation->id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
	?>
	...
	<?php
		echo ListView::widget([
		    ...
		    'itemView' => function ($model, $key, $index, $widget) {
		    	return $this->render('stakeholder-list', [
		    		'model' => $model,
		    		'index' => $index+1,
		    	]);
		    },
