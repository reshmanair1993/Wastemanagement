...
<div class="row bg-title">
  ...
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => ' Service Requests', 'url' => ['service-requests/special-services']];
   $this->title =  'Create';
      ...
      <div class="col-sm-12 col-xs-12">
        ...
        <?php elseif($userRole!='customer'):?>
         ...
         <div class="col-sm-6 col-xs-6">
           ...
           <?php else:?>
          <?php echo $form->field($modelServiceRequest, 'account_id_customer')->hiddenInput(['class'=>'form-control form-control-line','id'=>'supervisor-person-id','value'=>$modelUser->id])->label(false);?>     
    <?php endif;?>
      ...
      <?php endif;?>
       <div class="col-sm-6 col-xs-6">
            <div class="form-group">
              <div class="col-sm-6 col-xs-6">
            <?php
                $list = $modelServiceRequest->getSpecialServiceList();
                 $listData=ArrayHelper::map($list, 'id', 'name');
