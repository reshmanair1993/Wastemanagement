...
$modelImage = new Image;
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 add-tip-form" style="background: #f9f9f9; border: 1px solid #eee; padding-top: 10px; padding-bottom: 10px;">
        ...
        <div class="col-sm-6 col-xs-6">
            <div class="form-group">
                <div class="col-sm-6 col-xs-6">
                    <?=$form->field($modelServiceAssignment, 'lat_update_from')->textInput(['maxlength' => true,'class'=>'form-control form-control-line','value'=>isset($model->fkServiceAssignment)?$model->fkServiceAssignment->lat_update_from:''])->label('Latitude');?>
                </div>
            </div>
        </div>
         <div class="col-sm-6 col-xs-6">
        ...
        <?php if(isset($model->fkServiceAssignment->lat_update_from)&&isset($model->fkServiceAssignment->lng_updated_from)):
