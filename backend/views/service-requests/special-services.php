...
$this->title = Yii::t('app', 'Special Service Requests');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Special Service Requests</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Special Service Requests';
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <p>
          <?= Html::a(Yii::t('app', 'Create Special Service Request'), ['create'], ['class' => 'btn btn-success']) ?>
        </p>
      </div>
    <?php endif;?>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'special-services','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
    ...
    $columns = [
        ['class' => 'yii\grid\SerialColumn'],
              [
                    ...
                    'value'=>function ($model) {
                      ...
                      return Html::a(ucwords($model->getCustomer($model->account_id_customer)),['service-requests/view-request?id='.$model->id],['data-pjax'=>0]);
                    else:
        ...
        $columns3 = [             
                  ...
                  {
                $page = isset($_GET['page']) ? $_GET['page']:1;
                 if(isset($model->fkServiceAssignment)&&$model->fkServiceAssignment->servicing_status_option_id!=null):
