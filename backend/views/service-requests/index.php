...
<div class="row bg-title">
    ...
    <?php endif;?> -->
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['service-requests/index','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
    ...
    <?php endif;?>
      ...
      if(isset($key)) {
        ...
        $options['options'] = [$option => ['selected'=>'selected']];
            ...
            echo $form->field($modelServiceRequest, 'ward_id')->dropDownList($listData, $options)->label('Ward')?>
            </div>
          </div>
        <?php endif;?>
       <div class="col-lg-2 col-sm-2 col-md-8 col-xs-12">
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
    ...
    $columns = [
        ...
        $columns3 = [             
                  ...
                  {
                $page = isset($_GET['page']) ? $_GET['page']:1;
                if(isset($model->fkServiceAssignment->servicing_status_option_id)&&$model->fkServiceAssignment->servicing_status_option_id!=null):
                      return Html::a('Rating',['service-requests/rating?id='.$model->id],['data-pjax'=>0]);
                    elseif($model->marked_rating_value!=null):
                      return $model->marked_rating_value;
                    else:
