...
?>
  ...
  <br>
              <div class="col-md-6">
                ...
                <div class="x_panel">
                  <div class="x_title">
                  <h2>Bio Wastemanagement Management</h2>
         ...
         <?php  $usersCount = Customer::find()->select('count(*)')->scalar(); 
           ...
           $qry ="SELECT waste_collection_method.name as label, count(*) as value FROM customer left join waste_collection_method on waste_collection_method.id=customer.bio_waste_collection_method_id where customer.status=1 and waste_collection_method.status=1 and waste_collection_method.waste_category_id=2";
...
$('.btn-behaviour-filter').on('change', function() {
 ...
 <?php  $usersCount = Customer::find()->select('count(*)')->scalar(); 
           ...
           $qry1 ="SELECT waste_collection_method.name as label, count(*) as value FROM customer left join waste_collection_method on waste_collection_method.id=customer.non_bio_waste_collection_method_id where customer.status=1 and waste_collection_method.status=1 and waste_collection_method.waste_category_id=3";
           if(isset($ward)&&$ward!=null)
           {
            $qry1.=" and customer.ward_id=:wards";
           }
           // if(isset($from)&&$from!=null)
           // {
           //  $qry.=" and customer.created_at>=:from";
           ...
           //  $qry.=" and customer.created_at<=:to";
           // }
           $qry1.=" GROUP BY waste_collection_method.id";
