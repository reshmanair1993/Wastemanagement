...
$modelImage = new Image;
	...
	Pjax::begin(['timeout' => 50000 ,'enablePushState' => false, 'id' =>'Pjax-edit-social-media','options'=>['data-loader'=>'.preloader']]);
	$form = ActiveForm::begin(['action' => ['update-social-media','id'=>$modelSocialMedia->id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
	?>
         ...
         <div class="col-sm-12 col-xs-12">
          ...
          <div class="col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <img src="<?=$modelSocialMedia->getProfileUrl()?>" />
                </div>
                  <div class="col-sm-12 col-xs-6">
...
$('.close-job-toggle').click(function() {
  ...
  $('.collapse.in').collapse('hide'); //hide all open collapses
   ...
   <?php
  $this->registerJs("
    $('#Pjax-edit-social-media').on('pjax:end', function() {
      $.pjax.reload({container:'#Pjax-add-social-media'});
    });
