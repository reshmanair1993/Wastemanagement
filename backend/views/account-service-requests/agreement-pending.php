...
$this->title = Yii::t('app', 'Agreement Pending');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Agreement Pending</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Agreement Pending';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['account-service-requests/agreement-pending','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
    ...
    <?php
                ...
                [
                    ...
                    'value'=>function ($model) {
                      ...
                      $name =  isset($model->fkAccount->fkCustomer->id)?$model->fkAccount->fkCustomer->lead_person_name:'';
                        ...
                        return Html::a($name,['account-service-requests/update-agreement-pending?id='.$model->id],['data-pjax'=>0]);
      ...
      return $gtName;
        ...
        $columns2 = [             
                   [
                  'format'=>'raw',
                  'attribute' => 'is_agreement_done',
                  // 'label' => 'Active/Inactive' ,
                  'label' => 'Agreement Approve' ,
                  'encodeLabel' => false,
                  'value' => function ($model)
                  {
                    $statusLabels = [
                    ...
                    $status = (int)$model->is_agreement_done;
                    ...
                    $url = Yii::$app->urlManager->createUrl(['account-service-requests/toggle-status-approved-agreement','id'=>$model->id]);
                    if($model->is_agreement_done==0){
                ...
                elseif($model->is_agreement_done==1)
                {
