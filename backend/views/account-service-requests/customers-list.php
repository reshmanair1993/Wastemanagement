...
<div class="sbhrm-asset-allocation-index">
    ...
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Non Residential Customers';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['account-service-requests/customers-list','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
...
<?php endif;?>
      ...
      if(isset($key)) {
        ...
        $options['options'] = [$option => ['selected'=>'selected']];
            ...
            $list=BuildingType::getTypeNonResidential();
            $listData=ArrayHelper::map($list, 'id', 'name');
   ...
   $gridSettings = [
     "Customers-show-name" => [
       ...
       'value'=>function ($model) {
         ...
         if(!$model->getServiceDetails()){
         return Html::a(Html::encode(ucwords($model->lead_person_name)),['account-service-requests/view-customer?id='.$model->id],['data-pjax'=>0]);
       }else
       {
