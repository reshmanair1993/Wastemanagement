...
<div class="row bg-title">
    ...
    <?php endif;?> -->
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'non-residential','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
        ...
        $columns = [
                ...
                [
                    ...
                    'value'=>function ($model) {
                      ...
                      if($model->is_pre_approved!=1)
                      {
                        return Html::a($name,['account-service-requests/update?id='.$model->id],['data-pjax'=>0]);
                      }else
                      {
                        return Html::a($name);
                      }
