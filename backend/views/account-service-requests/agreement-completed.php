...
$this->title = Yii::t('app', 'Agreement Completed');
...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Agreement Completed';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['account-service-requests/agreement-completed','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
                ...
                [
                    ...
                    'value'=>function ($model) {
                      ...
                      $name =  isset($model->fkAccount->fkCustomer->id)?$model->fkAccount->fkCustomer->lead_person_name:'';
                        ...
                        return Html::a($name,['account-service-requests/agreement-completed-detail?id='.$model->id],['data-pjax'=>0]);
