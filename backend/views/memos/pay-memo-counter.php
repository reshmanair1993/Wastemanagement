...
$this->params['breadcrumbs'][] = $this->title;
  ...
  $form = ActiveForm::begin(['action' => ['pay-memo-counter','id'=>$model->id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
...
<div class="row bg-title">
  ...
  <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Memo ', 'url' => ['/memos/index']];
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-12">
    ...
    <?php
    echo $form->field($model, 'payment_counter_account_id')->widget(DepDrop::classname(), [
    'type'=>DepDrop::TYPE_SELECT2,
    // 'data'=>[$model->getPaymentCounterAdmin()],
    ...
    'pluginOptions'=>[
       ...
       'class'=>'form-control form-control-line',
        'placeholder'=>'Select...',
        'url'=>Url::to(['/memos/payment-counter-admin'])
    ]
 ])->label(false);
    ?>
...
<div class="memo-preview">
    <div class="logo-section">
      ...
      <div class="row" style="font-size: 18px !important;">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12  field-padding field-content" style="padding-left:50px; margin-top : 0px;">
            <?php
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12  field-padding field-content" style="padding-left:50px;margin-top: 10px;margin-bottom: 20px;">
            <?php
...
<div class="col-lg-12 col-md-12 col-sm-6 col-12 field-padding">
      <?= Html::submitButton('Pay', ['class' => 'print-btn btn btn-success']) ?>
</div>
<?php
ActiveForm::end();
?>
