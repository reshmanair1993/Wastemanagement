    ...
    <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        ...
        <div class="col-lg-2 col-sm-2 col-md-8 col-xs-12">
           ...
           $keyword =  isset($_POST['id'])?$_POST['id']:'';
           ?>
            <input type="text" name="id" value="<?php if (isset($keyword)) echo $keyword; ?>" style="background-color:#ccc;color:white;margin-top: 0px;" placeholder="Search..." class="form-control btn-behaviour-filter"> <a href="" class="active"></a>
        </div>
          <?php ActiveForm::end(); ?>
          </div>
  </div>
            ...
            [
              ...
              'value'=> function ($model) {
                ...
                if($model->is_paid == 1){
                  ...
                  return Html::a('Pay',['memos/pay-memo-counter?id='.$model->id],['data-pjax'=>0]);
                }
              },
            ],
            [
               ...
               'value'=>function ($model) {
                $page = isset($_GET['page']) ? $_GET['page']:1;
                $page = $page;
                $url =  Yii::$app->urlManager->createUrl(['memos/delete-memo','id'=>$model->id]);
...
<?php
  ...
  if ($updateSuccess == 1):
    $this->registerJs("
    swal({title:'Success',text: 'Memo has been updated successfully', type:'$type'});
    ");
  endif ;
?>
<?php
