...
<div class="row">
  <div class="col-md-12">
    ...
    $columns = [
                    [
                        'label' => 'Customer',
                        'value' =>'fkPaymentRequest.fkAccount.fkCustomer.lead_person_name',
                    ],
                    [
                    'attribute' =>  'view',
                    'label' =>'View',
                    ...
                    'value'=>function ($model) {
                      ...
                      return Html::a('View',['payments/view?id='.$model->id],['data-pjax'=>0]);
                   ...
                   [
                    ...
                    'value'=>function ($model) {
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      return isset($model->fkPaymentRequest->fkAccount->fkCustomer->id)?Customer::getFormattedCustomerId($model->fkPaymentRequest->fkAccount->fkCustomer->id):null;
                       // return Html::a($model->lead_person_name);
                    ...
                    [
                        'label' => 'Service',
                        'value' =>'fkPaymentRequest.fkServiceRequest.fkService.name',
                    ],
                    [
                        'label' => 'Green Technician',
                        'value' =>'fkAccount.fkPerson.first_name',
                    ],
                    'amount',
                    [
                    'attribute' =>  'date',
     ...
     ];if(Yii::$app->user->can('payment-requests-delete-request')||$userRole=='super-admin'){
        $columns2 = [             
                   [
                   'attribute' => 'delete',
                   'label' =>'Delete',
