...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Ward</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Ward', 'url' => ['/wards']];
    ...
    <?php $form = ActiveForm::begin();?>
        <div class="col-sm-6 col-xs-6">
         ...
         <div class="col-sm-6 col-xs-6">
            <div class="form-group">
                <div class="col-sm-6 col-xs-6">
                    <?=$form->field($model, 'name_en')->textInput(['maxlength' => true,'class'=>'form-control form-control-line'])->label('English Name');?>
                </div>
            </div>
        </div>
         <div class="col-sm-6 col-xs-6">
        ...
        <div class="col-sm-6 col-xs-6">
            <div class="form-group">
                <div class="col-sm-6 col-xs-6">
                    <?=$form->field($model, 'ward_no')->textInput(['maxlength' => true,'class'=>'form-control form-control-line']);?>
                </div>
            </div>
        </div>
        ...
        <?php $district= $model->getDistricts();
          ...
          <div class="col-sm-6 col-xs-6">
            ...
            echo $form->field($model, 'lsgi_id')->widget(DepDrop::classname(), [
                'type'=>DepDrop::TYPE_SELECT2,
                 'data'=>[$model->getLsgi($model->lsgi_id)],
