...
$this->title = Yii::t('app', 'Admin Lsgi');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Lsgi Admin</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Lsgi Admin';
      ...
      <?php if(Yii::$app->user->can('create-admin-lsgi')||$userRole=='super-admin'):?>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
             <p>
        <?= Html::a(Yii::t('app', 'Create Lsgi Admin'), ['create-admin-lsgi'], ['class' => 'btn btn-success']) ?>
    </p>
        </div>
      <?php endif;?>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'admin-lsgi','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
...
<div class="row">
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
                      'id' =>'pjax-account-admin-lsgi-list', 'options'=>['data-loader'=>'.preloader']]); ?>
   ...
   <?php 
        $columns = [
              [
                    ...
                    'value'=>function ($model) {
                      ...
                      $modelUser  = Yii::$app->user->identity;
                      $userRole = $modelUser->role;
                      if(Yii::$app->user->can('update-admin-lsgi')||$userRole=='super-admin'):
                      return Html::a($model->username,['account/update-admin-lsgi?id='.$model->id],['data-pjax'=>0]);
                    else:
        ...
        if(Yii::$app->user->can('delete-admin-lsgi')||$userRole=='super-admin'){
         $columns2 = [             
                  [
                   'attribute' => 'delete',
                   'label' =>'Delete',
