...
$this->title = Yii::t('app', 'Survey Coordinator');
...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Survey Coordinator';
      ...
      <?php if(Yii::$app->user->can('create-coordinator')||$userRole=='super-admin'):?>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
           <p>
        <?= Html::a(Yii::t('app', 'Create Survey Coordinator'), ['create-coordinator'], ['class' => 'btn btn-success']) ?>
    </p>
        </div>
      <?php endif;?>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'coordinators','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
...
<div class="row">
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
                      'id' =>'pjax-account-coordinator-list', 'options'=>['data-loader'=>'.preloader']]); ?>
    <?php 
        $columns = [
              [
                    'attribute' => 'username',
                    ...
                    'value'=>function ($model) {
                      ...
                      $modelUser  = Yii::$app->user->identity;
                      $userRole = $modelUser->role;
                      if(Yii::$app->user->can('update-coordinator')||$userRole=='super-admin'):
                      return Html::a($model->username,['account/update-coordinator?id='.$model->id],['data-pjax'=>0]);
                    else:
        ...
        if(Yii::$app->user->can('delete-coordinator')||$userRole=='super-admin'){
         $columns2 = [             
                  [
                   'attribute' => 'delete',
                   'label' =>'Delete',
                   ...
                   'value'=>function ($model) {
                    ...
                    return  "<a  onclick=\"ConfirmDelete(function(){
                      deleteItem('$url','#pjax-account-coordinator-list',$page,function() {
                      });
