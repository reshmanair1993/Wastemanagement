...
<div class="row bg-title">
  ...
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Supervisor', 'url' => ['account/supervisors']];
if($modelAccount->id){
    ...
    'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enctype' => 'multipart/form-data', 'enableAjaxValidation' => true]]);
      ...
      <?php if($userRole=='admin-lsgi'):?><?php
        ...
        <?php $unit= $modelAccount->getUnits($modelUser->lsgi_id);
                    ...
                    echo $form->field($modelAccount, 'green_action_unit_id')->dropDownList($listData, ['prompt' => 'Select from the list','class'=>'form-control form-control-line','id'=>'unit-id','value'=>$modelAccount->getUnit($modelAccount->green_action_unit_id)])->label('Haritha Karma Sena')?>
                  </div>
                </div>
              </div>
          <?php endif;?>
          <?php if($userRole=='admin-hks'):?>
            <?php
