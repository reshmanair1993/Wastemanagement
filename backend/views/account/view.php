...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Surveyor</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Surveyor', 'url' => ['account/index']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Surveyor'), 'url' => ['index']];
if($modelAccount->id){
   $this->title =  ucfirst($modelAccount->username);
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false">Surveyor Info</a></li>
            <li><a href="#tab_2" data-toggle="tab" aria-expanded="false">Wards</a></li>
        </ul>
        <div class="tab-content" style="    margin-left: 18px;">
            <div class="tab-pane active" id="tab_1">
                <?php
                    Pjax::begin(['timeout' => 50000 ,'enablePushState' => false, 'id' =>'Pjax-surveyor-edit','options'=>['data-loader'=>'.preloader']]);
                    $form = ActiveForm::begin(['action' => ['update','id'=>$modelAccount->id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
                    ?>
       ...
       <?php if($userRole=='admin-lsgi'):?><?php
        ...
        <?php $unit= $modelAccount->getUnits($modelUser->lsgi_id);
         ...
         <div class="col-sm-6 col-xs-6">
          ...
          <?php endif;?>
          <?php if($userRole=='coordinator'):?><?php

           echo $form->field($modelAccount, 'lsgi_id')->hiddenInput(['value'=>$modelUser->lsgi_id])->label(false);
            echo $form->field($modelAccount, 'green_action_unit_id')->hiddenInput(['value'=>$modelUser->green_action_unit_id])->label(false);
            echo $form->field($modelAccount, 'survey_agency_id')->hiddenInput(['value'=>$modelUser->survey_agency_id])->label(false);
            ?>
          <!--  <div class="col-sm-6 col-xs-6">
            <div class="form-group">
                <div class="col-sm-6 col-xs-6">
