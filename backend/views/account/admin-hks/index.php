...
$this->title = Yii::t('app', 'Admin Hks');
...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
       ...
       <?php if(Yii::$app->user->can('create-admin-hks')||$userRole=='super-admin'):?>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
           <p>
        <?= Html::a(Yii::t('app', 'Create Admin Hks'), ['create-admin-hks'], ['class' => 'btn btn-success']) ?>
    </p>
        </div>
      <?php endif;?>
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' => 'admin-hks','options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search hidden-sm hidden-xs m-r-10']]);?>
...
<div class="row">
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
                      'id' =>'pjax-account-admin-hks-list', 'options'=>['data-loader'=>'.preloader']]); ?>
   <?php 
        $columns= [
              [
                    'attribute' => 'username',
                    ...
                    'value'=>function ($model) {
                      ...
                      $modelUser  = Yii::$app->user->identity;
                      $userRole = $modelUser->role;
                      if(Yii::$app->user->can('update-admin-hks')||$userRole=='super-admin'):
                      return Html::a($model->username,['account/update-admin-hks?id='.$model->id],['data-pjax'=>0]);
                    else:
        ...
        ];if(Yii::$app->user->can('delete-admin-hks')||$userRole=='super-admin'){
        $columns2 = [             
                   [
                   'attribute' => 'delete',
                   'label' =>'Delete',
                   ...
                   'value'=>function ($model) {
                    ...
                    return  "<a  onclick=\"ConfirmDelete(function(){
                      deleteItem('$url','#pjax-account-admin-hks-list',$page,function() {
                      });
