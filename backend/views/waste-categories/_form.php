...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Waste Category</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Waste Category', 'url' => ['/waste-categories']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Waste Category'), 'url' => ['index']];
if($model->id){
