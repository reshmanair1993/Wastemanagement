...
<?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
                      'id' =>'pjax-roles-list', 'options'=>['data-loader'=>'.preloader']]); ?>
  ...
  <div class="row bg-title">
    ...
    <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
             <p>
        <?= Html::a(Yii::t('app', 'Create Roles'), ['create-roles'], ['class' => 'btn btn-success']) ?>
    </p>
        </div>
  </div>
...
<?= GridView::widget([
    ...
    'columns' => [
        [
          ...
          'format' => 'raw',
          'value'=>function ($modelAuthItem) {
            return Html::a(ucfirst($modelAuthItem->name),['rbac/update-roles','name'=>$modelAuthItem->name],['data-pjax'=>0]);
          },
        ],
        // [
        //    'label' =>'Delete',
