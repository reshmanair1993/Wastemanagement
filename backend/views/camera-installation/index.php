...
$this->title = 'Camera Installation';
  ...
  <div class="row bg-title">
    ...
    <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
             <p>
        <?= Html::a(Yii::t('app', 'Create camera installation'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
        </div>
  </div>
        ...
        'columns' => [
            ...
            [
              ...
              'value'=>function ($modelCameraInstallationCheckList) {
                return Html::a(ucfirst($modelCameraInstallationCheckList->name),['camera-installation/update','id'=>$modelCameraInstallationCheckList->id],['data-pjax'=>0]);
              },
            ],
            [
              'label' =>'Image',
