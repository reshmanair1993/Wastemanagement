...
<div class="row bg-title">
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Building Type</h4>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
  </div>
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Building Type', 'url' => ['/building-types']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Building Type'), 'url' => ['index']];
if($model->id){
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2" data-toggle="tab" aria-expanded="false">Sub Types</a></li>
        </ul>
