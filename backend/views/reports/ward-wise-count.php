            ...
            [
                 ...
                 [
                    ...
                    'value'=>function ($model) {
                      ...
                      $count = Customer::getWardHouseCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                   [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardFlatCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardHospitalCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardShopCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardOfficeCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardAuditoriumCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardMarketCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardPublicPlaceCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $count = Customer::getWardReligiousCount($model->id,$from,$to);
                      return $count;
                    },
                  ],
                  [
                    ...
                    'value'=>function ($model) {
                     ...
                     //   $to                = $to ? \Yii::$app->formatter->asDatetime($to, "php:Y-m-d 23:59:00") : '';
                      ...
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      $houseCount = Customer::getWardHouseCount($model->id,$from,$to);
                      $flatCount = Customer::getWardFlatCount($model->id,$from,$to);
                      $hospitalCount = Customer::getWardHospitalCount($model->id,$from,$to);
                      $shopCount = Customer::getWardShopCount($model->id,$from,$to);
                      $officeCount = Customer::getWardOfficeCount($model->id,$from,$to);
                      $auditoriumCount = Customer::getWardAuditoriumCount($model->id,$from,$to);
                      $marketCount = Customer::getWardMarketCount($model->id,$from,$to);
                      $publicPlaceCount = Customer::getWardPublicPlaceCount($model->id,$from,$to);
                     $religiousCount = Customer::getWardReligiousCount($model->id,$from,$to);
