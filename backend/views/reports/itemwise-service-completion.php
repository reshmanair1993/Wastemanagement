...
$scrollingTop = 10;
$this->title = Yii::t('app', 'Itemwise Service Completion Report');
...
<div class="sbhrm-asset-allocation-index">
    ...
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Itemwise Service Completion Report</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Itemwise Service Completion Report';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/itemwise-service-completion','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
            ...
            [
                  ...
                  [
                    ...
                    'value'=>function ($model) {
                      ...
                      return $model->getCountCompleted($model->id,$from,$to,$type=1,$wardId);
                    },
                  ],        
        ];
  $pdfHeader = [
  'L' => [
    'content' => 'Itemwise Service Completion Report-'.date('d-M-Y'),
  ],
  'C' => [
    'content' => '',
    'font-size' => 10,
...
$pdfFooter = [
  ...
  'line' => true,
   ...
   echo GridView::widget([
    ...
    'columns' => $columns,
    'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'Itemwise Service Completion Report-'.date('d-M-Y')],
                   GridView::HTML => ['label' => 'Export as HTML', 'filename' => 'Itemwise Service Completion Report -'.date('d-M-Y')],
                   // GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'Itemwise Service Completion Report -'.date('d-M-Y')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'Itemwise Service Completion Report -'.date('d-M-Y')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Itemwise Service Completion Report -'.date('d-M-Y')],
                   GridView::PDF => [
    'filename' => 'Itemwise Service Completion Report -'.date('d-M-Y'),
    'config' => [
      'methods' => [
        'SetHeader' => [
      ...
      'options' => [
        'title' => 'Itemwise Service Completion Report -'.date('d-M-Y'),
        'subject' =>'Itemwise Service Completion Report -'.date('d-M-Y'),
