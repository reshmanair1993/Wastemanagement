...
$this->title = Yii::t('app', 'Complaints Report');
...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Complaints Report';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/complaints','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search m-r-10']]);?>
...
<?php endif;?>
 <?php if($userRole=='supervisor'):?>
  ...
  //                     'id' =>'pjax-customers-list', 'options'=>['data-loader'=>'.preloader']]);
   ...
   $pdfHeader = [
  'L' => [
    'content' => 'Complaint Report-'.date('d-M-Y'),
  ],
  'C' => [
    'content' => '',
    'font-size' => 10,
   ...
   echo GridView::widget([
    ...
    'exportConfig' => [
                   ...
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Complaint Report -'.date('d-M-Y')],
                    GridView::PDF => [
    'filename' => 'Complaint Report -'.date('d-M-Y'),
    'config' => [
      'methods' => [
        'SetHeader' => [
      ...
      'options' => [
        'title' => 'Complaint Report -'.date('d-M-Y'),
        'subject' =>'Complaint Report -'.date('d-M-Y'),
