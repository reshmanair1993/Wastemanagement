...
$this->title = Yii::t('app', 'Waste Quantity Collected Report');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Waste Quantity Collected Report</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Waste Quantity Collected Report';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/waste-quantity-collected','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
  ...
  <?php endif;?>
      ...
      if(isset($key)) { 
        ...
        $options['options'] = [$option => ['selected'=>'selected']];
            ...
            $service=Service::getServiceListQuantity();
...
<div class="row att-today-count">
  <div class="col-md-12">
    <div class="white-box">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4>Total Quantity collected<span class="btn btn-primary"><?=$quantityCollected?></span></h4>
      </div>
   ...
   $columns = [
            [
                  ...
                  [
                    ...
                    'value'=>function ($model) {
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      return isset($model->fkServiceAssignment->quantity)?$model->fkServiceAssignment->quantity:'';
                    },
                  ],
                  [
  ...
  $pdfHeader = [
  'L' => [
    'content' => 'Waste Quantity Collected Report-'.date('d-M-Y'),
  ],
  'C' => [
    'content' => '',
    'font-size' => 10,
...
$pdfFooter = [
  ...
  'line' => true,
   ...
   echo GridView::widget([
    ...
    'columns' => $columns,
    'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'Waste Quantity Collected Report-'.date('d-M-Y')],
                   GridView::HTML => ['label' => 'Export as HTML', 'filename' => 'Waste Quantity Collected Report -'.date('d-M-Y')],
                   // GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'Waste Quantity Collected Report -'.date('d-M-Y')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'Waste Quantity Collected Report -'.date('d-M-Y')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Waste Quantity Collected Report -'.date('d-M-Y')],
                    GridView::PDF => [
    'filename' => 'Waste Quantity Collected Report -'.date('d-M-Y'),
    'config' => [
      'methods' => [
        'SetHeader' => [
      ...
      'options' => [
        'title' => 'Waste Quantity Collected Report -'.date('d-M-Y'),
        'subject' => 'Waste Quantity Collected Report -'.date('d-M-Y'),
