...
$scrollingTop = 10;
$this->title = Yii::t('app', 'Plan Count Report');
...
<div class="sbhrm-asset-allocation-index">
    ...
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Plan Count Report</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Plan Count Report';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/plan-count','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search m-r-10']]);?>
...
?>" style="background-color:#ccc;color:white;margin-top: 0px;" placeholder="To....." class="form-control datepicker btn-behaviour-filter"> <a href="" class="active"></a>
   ...
   $columns = [
            [
                  ...
                  [
                    ...
                    'value'=>function ($model) {
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      return $model->fkAccount->fkCustomer->fkWard->name;
                    },
                  ],
                  [
                    'attribute' =>  'date',
  ...
  $pdfHeader = [
  'L' => [
    'content' => 'Plan Count Report-'.date('d-M-Y'),
  ],
  'C' => [
    'content' => '',
    'font-size' => 10,
...
$pdfFooter = [
  ...
  'line' => true,
   ...
   echo GridView::widget([
    ...
    // 'summary'=>'',
     'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'Plan Count Report-'.date('d-M-Y')],
                   GridView::HTML => ['label' => 'Export as HTML', 'filename' => 'Plan Count Report-'.date('d-M-Y')],
                   // GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'Itemwise Service Pending Report -'.date('d-M-Y')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'Plan Count Report-'.date('d-M-Y')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Plan Count Report-'.date('d-M-Y')],
                   GridView::PDF => [
    'filename' => 'Plan Count Report-'.date('d-M-Y'),
    'config' => [
      'methods' => [
        'SetHeader' => [
      ...
      'options' => [
        'title' => 'Plan Count Report-'.date('d-M-Y'),
        'subject' =>'Plan Count Report-'.date('d-M-Y'),
