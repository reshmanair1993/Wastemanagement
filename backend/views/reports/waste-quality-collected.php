...
$this->title = Yii::t('app', 'Waste Quality Collected Report');
...
<div class="row bg-title">
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/waste-quality-collected','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
  ...
  <?php endif;?>
      ...
      if(isset($key)) { 
        ...
        $options['options'] = [$option => ['selected'=>'selected']];
            ...
            $service=Service::getServiceListQuality();
  ...
  //                     'id' =>'pjax-customers-list', 'options'=>['data-loader'=>'.preloader']]);
   ...
   $columns = [
            [
                  ...
                  [
                    'attribute' =>  'quality',
                     'label' =>'Quality Collected',
                    'contentOptions'=>[ 'style'=>'width: 250px'],
                    'format' => 'raw',
                    'value'=>function ($model) {
                      $page = isset($_GET['page']) ? $_GET['page']:1;
                      return isset($model->fkServiceAssignment->fkQuality->name)?$model->fkServiceAssignment->fkQuality->name:'';
                    },
                  ],
                  [
