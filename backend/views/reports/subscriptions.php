...
$scrollingTop = 10;
$this->title = Yii::t('app', 'Subscription Report');
...
<div class="sbhrm-asset-allocation-index">
    ...
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Subscription Report</h4>
    </div>


      <div class="col-lg-3 col-sm-8 col-md-8 col-xs-12">
           <?php   $this->title =  'Subscription Report';
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['reports/subscriptions','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search m-r-10']]);?>
  ...
  //                     'id' =>'pjax-customers-list', 'options'=>['data-loader'=>'.preloader']]);
   ...
   $columns = [
            [
                  ...
                  //   'value'=>function ($model) {
                  //     $page = isset($_GET['page']) ? $_GET['page']:1;
                  //     return ucwords($model->fkAccount->fkCustomer->association_name);
                  //   },
                  // ],
                  [
   ...
   $pdfHeader = [
  'L' => [
    'content' => 'Subscription Report-'.date('d-M-Y'),
  ],
  'C' => [
    'content' => '',
    'font-size' => 10,
...
$pdfFooter = [
  ...
  'line' => true,
   ...
   echo GridView::widget([
    ...
    'columns' => $columns,
    'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'Subscription Report-'.date('d-M-Y')],
                   GridView::HTML => ['label' => 'Export as HTML', 'filename' => 'Subscription Report -'.date('d-M-Y')],
                   // GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'Subscription Report -'.date('d-M-Y')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'Subscription Report -'.date('d-M-Y')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'Subscription Report -'.date('d-M-Y')],
                   GridView::PDF => [
    'filename' => 'Subscription Report -'.date('d-M-Y'),
    'config' => [
      'methods' => [
        'SetHeader' => [
      ...
      'options' => [
        'title' => 'Subscription Report -'.date('d-M-Y'),
        'subject' => 'Subscription Report -'.date('d-M-Y'),
