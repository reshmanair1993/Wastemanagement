    ...
    <div class="sidebar-nav slimscrollsidebar">
       <!--  <div class="sidebar-head">
        ...
        <div class="sidebar-header hide-for-print">
          <a class="" href="<?=Url::to(['wms-dashboard/index'])?>">
            <img src=<?=Url::to('@web/images/180_90_green.png')?> alt="Green Trivandrum" style="margin-left: 26px;">
          </a>
          <a href="#" class="menu-toggle" style="display: none"><i class="ti-menu"></i></a>
        </div>
          <?php
...
//             ],
           [
              ...
              'active_icon' => 'dashboard_selected.png',
               ...
               'permissions' => [
                 'wms-dashboard-index','wms-dashboard-view-reports'
               ],
              'children' => [
               [
              'label' => 'Count Wise',
            ...
            [
              'label' => 'Chart Wise',
              'url' => ['wms-dashboard/view-reports'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['wms-dashboard-view-reports'],
              'icon' => 'dashboard_unselected.png',
              'active_icon' => 'dashboard_selected.png'
            ],
            ],
            ...
            [
              'label' => 'Non Residential Schedule  ',
              'url' => ['schedule/list'],
              'roles' => ['supervisor'],
              'permissions' => ['schedule-list'],
              'icon' => 'schedule_unselected.png',
              'active_icon' => 'schedule_selected.png'
            ],
            [
            ...
            [
              ...
              'url' => ['customers/public-customer-list'],
              'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor','coordinator'],
            ...
            [
              'label' => 'Plan Enabled Customers  ',
              'url' => ['customers/plan-enabled-list'],
              'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor','coordinator'],
              'permissions' => ['Customers-plan-enabled-list'],
              'icon' => 'plan-enable-customers.png',
              'active_icon' => 'plan-enable-customers-selected.png'
            ],
            [
              'label' => 'Login History ',
              'url' => ['history/index'],
              ...
              'active_icon' => 'login-history-selected.png'
            ],
            [
              'label' => 'Subscriptions  ',
            ...
            // [
            //   'label' => 'Non Residential Subscriptions  ',
            //   'url' => ['account-service-requests/non-residential'],
            //    'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor'],
            //    'permissions' => ['account-service-requests-non-residential'],
            //   'icon' => 'Subscription_unselected.png',
            //   'active_icon' => 'Subscription_selected.png'
            // ],
            [
              'label' => 'Non Residential Customers ',
              'url' => ['account-service-requests/customers-list'],
               'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor'],
               'permissions' => ['account-service-requests-customers-list'],
              'icon' => 'non-residential-customers.png',
              'active_icon' => 'non-residential-customers-selected.png'
            ],
            [
              'label' => 'Non Residential Service Enabling Request  ',
              'url' => ['account-service-requests/non-residential-service-enabling-request'],
               'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor'],
               'permissions' => ['account-service-requests-service-enabling-request'],
              'icon' => 'non-residential-service-enabling-request.png',
              'active_icon' => 'non-residential-service-enabling-request-seleceted.png'
            ],
            [
              'label' => 'Agreement',
              ...
              'children' => [
               [
              'label' => 'Pending',
              'url' => ['account-service-requests/agreement-pending'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['account-service-requests-agreement-pending'],
              'icon' => 'Closed_door_unselected.png',
              'active_icon' => 'Closed_door_selected.png'
            ],
            [
              'label' => 'Completed',
              'url' => ['account-service-requests/agreement-completed'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['account-service-requests-agreement-completed'],
              'icon' => 'Closed_door_unselected.png',
              'active_icon' => 'Closed_door_selected.png'
            ],
            ],
            ...
            [
              ...
              'active_icon' => 'self-service-selected.png',
               'roles' => ['super-admin','admin-lsgi','admin-hks','coordinator'],
               'permissions' => [
                 'self-services-index',
               ],
              'children' => [
               [
              'label' => 'Customer Self Service Requests',
              'url' => ['self-services/index'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['self-services-index'],
              'icon' => 'self-service.png',
              'active_icon' => 'self-service-selected.png'
            ],
            [
              'label' => 'Inoculam Bags Requests',
              'url' => ['self-services/inoculam-bags-requests'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['self-services-inoculam-bags-requests'],
              'icon' => 'Closed_door_unselected.png',
              'active_icon' => 'Closed_door_selected.png'
            ],
            ],
            ...
            [
             ...
             [
              'label' => 'Stock In/Stock Transfer',
              'icon' => 'dashboard_unselected.png',
              'active_icon' => 'dashboard_selected.png',
               'roles' => ['super-admin','admin-lsgi','admin-hks','coordinator'],
               'permissions' => [
                 'item-mrc-index','item-mrc-list'
               ],
              'children' => [
              [
              'label' => 'Items To MCF/RRF',
              'url' => ['item-mrc/index'],
               'roles' => ['super-admin','admin-lsgi'],
            ...
            [
              'label' => 'Sales Module',
              'url' => ['item-mrc/sales-module'],
               'roles' => ['super-admin','admin-lsgi'],
               'permissions' => ['item-mrc-sales-module'],
              'icon' => 'mrf_unselected.png',
              'active_icon' => 'mrf.png',
            ],
            [
            ...
            [
             ...
             'icon' => 'Detailed Report_unselected.png',
              ...
              [
              'label' => 'Summary Report',
              'url' => ['reports/waste-quality-collected-summary'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['reports-waste-quantity-collected'],
              'icon' => 'Summary Report_unselected.png',
              'active_icon' => 'Summary Report_selected.png'
            ...
            [
             ...
             [
              'label' => 'Outstanding Amount Report',
              // 'url' => ['reports/collection'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['reports-outstanding-amount'],
              'icon' => 'collection Report_unselected.png',
               'active_icon' => 'collection Report_selected.png',
               'children' => [
                [
              'label' => 'Detailed Report',
              'url' => ['reports/outstanding-amount'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['reports-outstanding-amount'],
              'icon' => 'Detailed Report_unselected.png',
               'active_icon' => 'Detailed Report_selected.png'
              ...
              [
              'label' => 'Summary Report',
              'url' => ['reports/outstanding-amount-summary'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['reports-outstanding-amount-summary'],
              'icon' => 'Summary Report_unselected.png',
               'active_icon' => 'Summary Report_selected.png'
              ],
               ],
            ...
            [
              'label' => 'Service Provider Amount Report',
              'url' => ['reports/amount-paid'],
               'roles' => ['super-admin','admin-lsgi','coordinator'],
               'permissions' => ['reports-amount-paid'],
              'icon' => 'Summary Report_unselected.png',
               'active_icon' => 'Summary Report_selected.png'
              ],
           ...
           [
              ...
              'permissions' => [
                ...
                'complaints-index','administration-type-index','waste-collection-intervals-index'
              ],
           ...
           [
            ...
            [
              'label' => 'Waste Collection Intervals',
              'url' => ['waste-collection-intervals/index'],
              'roles' => ['super-admin','admin-lsgi'],
            ...
            [
              'label' => 'Non Residential Waste Collection Intervals',
              'url' => ['waste-collection-intervals/non-residential'],
              'roles' => ['super-admin','admin-lsgi'],
            ...
            [
              'label' => 'Kitchen Bin Request  ',
              'url' => ['kitchen-bin-requests/index'],
              'roles' => ['super-admin','admin-lsgi','admin-hks','supervisor','coordinator'],
              'permissions' => ['kitchen-bin-requests-index'],
              'icon' => 'kitchenbin-request-unslected.png',
              'active_icon' => 'Kichenbin-request.png'
            ],
            [
              'label' => 'Settings',
              'url' => ['settings/about'],
              'roles' => ['super-admin','admin-lsgi','admin-hks','coordinator','supervisor','surveyor','camera-monitoring-admin'],
              'permissions' => ['settings-about'],
              'icon' => 'settings_unselected.png',
              'active_icon' => 'settings.png'
            ],
            [
              'label' => 'Logout',
              'url' => ['account/logout'],
          ...
          [
            ...
            [
              ...
              'url' => ['reports/waste-quality-collected'],
               ...
               'permissions' => ['reports-waste-quantity-collected'],
              'icon' => 'Waste_quality_collected_unselected.png',
              'active_icon' => 'Waste_quality_collected_selected Report_selected.png'
              ],
              [
              'label' => 'Summary Report',
              'url' => ['reports/customer-plan-summary'],
