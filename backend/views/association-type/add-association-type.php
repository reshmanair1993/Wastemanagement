...
<div class="row bg-title">
  ...
  <div class="col-lg-4 col-sm-8 col-md-8 col-xs-12">
   <?php
   $breadcrumb[]  = ['label' => 'Association type', 'url' => ['association-type/index']];
        ...
        <div class="row">
          <div class="col-sm-6 col-xs-6">
            <div class="form-group">
              <div class="col-sm-6 col-xs-6">
                <?=$form->field($modelAssociationType, 'name')->textInput(['value' => '','maxlength' => true,'class'=>'form-control form-control-line'])->label('Association name');?>
              </div>
            </div>
          </div>
        </div>
...
$message = isset($message)?$message:'Association has been added successfully';
