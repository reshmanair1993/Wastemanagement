...
$userRole = $modelUser->role;
  if(Yii::$app->user->can('Customers-update')||$userRole=='super-admin'):
    ?>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
   <?= Html::a(Yii::t('app', 'Update'), ['customers/view?id='.$model->id],['data-pjax'=>0], ['class' => 'btn btn-success']) ?>
  </div>
<?php endif;?>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    ?>
      ...
      <tr><td><b>Username</b></td><td><?=$model->fkCustomerAccount->username?></td></tr>
        ...
        <tr><td><b> Asset Number</b></td><td><?=$model->asset_number?></td></tr>
        <?php if($userRole=='super-admin'){?>
        <tr><td><b> Secret code</b></td><td><?=$model->service_secret_otp?></td></tr>
        <?php }?>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 profile">
        ...
        <?php if($model->association_name&&!$model->residential_association_id){?>
