...
$slabName = $model->getSlabName($model->slab_id);
$modelAccount = $model->fkAccount;
?>
<tr class="footable-even  " data-key="9">
	<td style="width: 50px"><?=$index?></td>
	<td style="width: 200px"><?=$name?></td>
	<td style="width: 200px"><?=$slabName?></td>
	...
	<td style="width: 50px">
	<?php $deleteUrl = Yii::$app->urlManager->createUrl(['customers/delete-slab','id'=>$model->id]);?>
	<a onclick="ConfirmDelete(function(){
		deleteItem('<?=$deleteUrl?>','#Pjax-add-service-slab',1,function() {});})" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn"><i aria-hidden="true" class="ti-close"></i></a></td>
</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php 
    echo
    $this->render('edit-service-slab',[
            'modelAccountSlabService'=> $model,
            'modelAccount'=> $model,
            ]);?>
      </div>
      </div>
