...
<div class="sbhrm-asset-allocation-index">
    ...
    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <?php $form = ActiveForm::begin(['action' =>Url::to(['customers/index','set'=>1]),'options' => ['','data-pjax' => true,'class' => 'page-main-form search-form app-search  m-r-10']]);?>
      <div class="col-lg-2 col-sm-2 col-md-8 col-xs-12">
       ...
       <div class="col-lg-2 col-sm-2 col-md-8 col-xs-12">
        <label>Qr Code</label>
           ...
           ?>
            <input type="text" name="qrcode" value="<?php if (isset($qrcode)) echo $qrcode; ?>" style="background-color:#ccc;color:white;margin-top: 0px;" placeholder="Search..." class="form-control btn-behaviour-filter"> <a href="" class="active"></a>
...
<?php endif;?>
      ...
      if(isset($key)) {
        ...
        $options['options'] = [$option => ['selected'=>'selected']];
            ...
            // $listData = array_merge($listDataNew,$listData1);
            echo $form->field($modelCustomer, 'residential_association_id')->dropDownList(['-1' => 'Without Association']+$listData, $options)->label(false)?>
            </div>
          </div>
             <!--  <div class="col-lg-2 col-sm-2 col-md-4 col-xs-12">
            <div class="form-group" style=" margin-top: -13px;">
...
?>" style="background-color:#ccc;color:white;margin-top: 0px;" placeholder="To....." class="form-control datepicker btn-behaviour-filter"> <a href="" class="active"></a>
   ...
   <br>
   <?php if(Yii::$app->user->can('Customers-view-export')||$userRole=='super-admin'){?>
   <button style="background: #00BEF5;" onclick="tableToExcel('tblData','Customer')">Export To Excel</button>
   <?php }?>
    <br>
   <div class="row">
  <div class="col-md-12">
  ...
  <?php Pjax::begin(['timeout' => 50000,'enablePushState' => false,
   ...
   $gridSettings = [
     ...
     "Customers-show-set-qrcode" => [
       ...
       'value'=>function ($model) {
         $page = isset($_GET['page']) ? $_GET['page']:1;
         $modelQrCode = QrCodes::find()->where(['customer_id'=>$model->id])->andWhere(['status'=>1])->one();
         if(isset($modelQrCode))
           return $modelQrCode->value;
         else
         return Html::a('Set Qr Code',['customers/set-qr-code?id='.$model->id],['data-pjax'=>0]);
       },
     ],
     ...
     "Customers-show-building-type" => 'building_type_name',
     "Customers-show-time" => [
       'attribute' =>  'time',
       'label' =>'Time',
       'contentOptions'=>[ 'style'=>'width: 250px'],
...
//         function exportTableToExcel(tableID, filename = 'Customer'){
//     var downloadLink;
...
<script type="text/javascript">
  ...
  return function(table, name) {
    ...
    var ctx = {worksheet: name || 'Customer', table: table.innerHTML}
