...
<?php
	$form = ActiveForm::begin(['action' => ['customers/set-user-password?id='.$id],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
?>
<br>
