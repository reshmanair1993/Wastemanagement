   ...
   $columns = [
            [
                    ...
                    'value'=>function ($model) {
                      ...
                      return Html::a(Html::encode(ucwords($model->lead_person_name)),['customers/view-details?id='.$model->id],['data-pjax'=>0]);
        ...
        if(Yii::$app->user->can('Customers-delete-customer')||$userRole=='super-admin'){
        $columns2 = [             
                   [
                   'attribute' => 'delete',
                   'label' =>'Delete',
